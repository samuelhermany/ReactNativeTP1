export const questoes = [
    {
        ...
        opcao_correta: 1,// index da opção correta
    },
    {
        pergunta: "2) Qual linguagem é usada no React Native?",
        opcoes: [
            "A) Java",
            "B) Objective-C",
            "C) JavaScript",
    ...
    {
        pergunta: "3) Qual é a função principal do componente 'View'?",
        opcoes: [
    ...
    {
            pergunta: "4) Como se aplica estilo em React Native?",
            opcoes: [
    ...
    },
    {
        ...
        opcao_correta: 0,// index da opção correta
    },
    {
    ...
    {
        pergunta: "8) Como você define um estado em um componente funcional?",
        opcoes: [
    ...
    {
        pergunta: "10) Para que serve o 'Expo' no desenvolvimento com React Native?",
        opcoes: [
